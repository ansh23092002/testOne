  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-30 bg-gray-200 p-2 rounded-3xl">
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="hidden md:block bg-white px-3 py-2 rounded-3xl">
          <div className="w-18 md:w-26 h-10 md:h-12 bg-black rounded-2xl flex items-center justify-center">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <div className="flex items-center gap-2 md:gap-3 pl-2 md:pl-4 bg-white p-2 rounded-3xl">
            <div className="text-right hidden sm:block">
              <p className="text-xs md:text-sm font-semibold text-gray-900"> Admin</p>
